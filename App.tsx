...
const TeacherDashboard = lazy(() => import('./components/TeacherDashboard') as Promise<{ default: React.ComponentType<{ user: User }> }>);
const StudentDashboard = lazy(() => import('./components/StudentDashboard') as Promise<{ default: React.ComponentType<{ user: User }> }>);
const StudentCourseList = lazy(() => import('./components/course/StudentCourseList') as Promise<{ default: React.ComponentType<{ user: User }> }>);
const TopicDetail = lazy(() => import('./components/course/TopicDetail') as Promise<{ default: React.ComponentType<{ user: User }> }>);
